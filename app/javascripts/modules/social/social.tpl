...
<div class="w-social-share-share">
    <div class="header">
        <span class="text-secondary">{{= i18n.misc.SHARE_WIDGET_SHARE_TIP }}</span>
    ...
    <textarea class="input-content" placeholder="{{= i18n.misc.SHARE_WIDGET_CONTENT_TIP_TEXT }}"></textarea>
...
<div class="w-social-share-share">
    <p class="header">
        <span>{{= i18n.misc.SHARE_WIDGET_SHARE_TIP }}</span>
        <a href="###" class="exit-oauth">{{= i18n.misc.SHARE_WIDGET_EXIT_TEXT }}</a>
        <span class="nickname"></span>
    </p>

    <textarea placeholder="{{= i18n.misc.SHARE_WIDGET_CONTENT_TIP_TEXT }}"></textarea>
    <p class="share-tip"></p>
    <div class="w-ui-loading-small info_loading send-loading" >
        <div class="anima">
            <div class="rotor rotor1"></div>
...
<script type="text/x-ui-template" id="social-platform-selector">
    <span class="text-thirdly"{{= i18n.misc.SHARE_TO }}</span>
...
<script type="text/x-ui-template" id="social-platform-selector-big">
    <div class="big-ctn hbox">
        ...
        <span data-type="sina">{{= i18n.misc.SHARE_TO_SINA }}</span>

        <input type="checkbox" class="social-platform-big" data-type="qzone" />
        <span data-type="qzone">{{= i18n.misc.SHARE_TO_QQ }}</span>
    </div>

    <div class="big-ctn hbox">
        <input type="checkbox" class="social-platform-big" data-type="tqq" />
        <span data-type="tqq">{{= i18n.misc.SHARE_TO_QZONE }}</span>

        <input type="checkbox" class="social-platform-big" data-type="renren" />
        <span data-type="renren">{{= i18n.misc.SHARE_TO_RENREN }}</span>
    </div>
</script>

<script type="text/x-ui-template" id="preview">
    <div class="share-preview">
        <h3 class="share-preview-header">{{= i18n.misc.SHARE_WIDGET_PREVIEW_PIC }}</h3>
        <a href="###" class="view-from-pc">{{= i18n.misc.VIEW_PIC }}</a>
