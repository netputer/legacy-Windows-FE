...
(function (window) {
    define([
        ...
        var menus = [{
            ...
            count : -1,
            order : 20,
            icon : 'icomoon icomoon-nav-contact'
        }, {
            ...
            tab : 'music',
            order : 40,
            icon : 'icomoon icomoon-nav-music'
        }, {
            ...
            count : -1,
            order : 50,
            icon : 'icomoon icomoon-nav-photo',
            module : 'photo',
            tab : 'phone'
        }, {
            ...
            tab : 'video',
            order : 60,
            icon : 'icomoon icomoon-nav-video'
        }, {
