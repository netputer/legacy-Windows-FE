...
(function (factory) {
    ...
    Wookmark = (function() {
        ...
        function Wookmark(handler, options) {
            ...
            this.columns = this.containerWidth = null;
        ...
        Wookmark.prototype.onResize = function() {
            ...
            window.cancelAnimationFrame(this.requestedId);
            this.requestedId = window.requestAnimationFrame(this.layout.bind(this));
        };
            ...
            for (i = 0; i < this.placeholders.length; i++) {
                ...
                if (i >= columnsLength || !column[column.length - 1]) {
                    ...
                    $placeholder.css({
                        ...
                        '-webkit-transform': 'translate3d(' + i * columnWidth + sideOffset + 'px, ' + top +'px, 0)',
            ...
            for (; i < this.columns.length; i++) {
                ...
                for (k = 0; k < column.length; k++, j++) {
                    ...
                    (itemBulkCSS[j] = {
                        obj: $item,
                        css: {
                            '-webkit-transform': 'translate3d(' + sideOffset + 'px, ' + currentHeight + 'px, 0)'
                        }
                    });
