...
define({
    ...
    EMPTY_TIP_WEB_APP_NOT_LOGIN : '您想找到曾经安装过的应用吗？立即 <span class="button-login link">登录豌豆荚</span> 就能把它们都找回来！',
    ...
    WEB_APPS : '下载过的应用 ({1})',
    WEB_APPS_DES : '查看您下载过的 {1} 个应用。',
    WEB_APPS_DES_EMPTY : '查看您下载过的应用。',
    WEB_APPS_EMPTY : '下载过的',
    WEB_APPS_DES_LOGIN : '登录豌豆荚查看下载过的应用。',
    WEB_APPS_TITLE : '下载过的应用',
    WEB_APPS_NUMBER : '您共下载过 {1} 个应用，',
    WEB_APPS_PERCENT : '超过了 {1}% 的豌豆荚用户。',
    ...
    DO_U_LIKE_THIS_APP : '喜欢这款应用么',
    DO_U_LIKE_THIS_APP2 : '您喜欢这款应用吗',
    LIKE : '喜欢',
    UNLIKE : '不喜欢',
    ...
    COMMENTARY : '评论',
    COMMENTARY_APP : '评论应用',
    COMMENTARY_APP_SUCCESS : '评论成功！',
    COMMENTARY_APP_FAILED : '评论失败！',
    LOGIN : '登录',
    SYNC : '同步：',
    MODIFY : '发表',
    SEND_SUCCESS : '成功',
    ...
    BUTTON_REFRESH_LIST_LABEL : '刷新列表',

    BUTTON_INSTALL_LABEL : '安装',
    BUTTON_CANCEL_LABEL : '取消',
    ...
    ONE_KEY_TRANSFER_LABEL : '一键移动({1})',
    ONE_KEY_TRANSFER_TITLE : '一键移动',
    ONE_KEY_UNINSTALL : '一键清理',
    ONE_KEY_UNINSTALL_DES : '检测到您有 {1} 个应用可以清理',
    INSTALL : '安装',
    INSTALLING : '安装中',
    UNINSTALL : '卸载',
    APP_DETAIL : '应用详情',
    ...
    APPS_NONE_TRANSFER_TEXT : '没有可转移的应用。',
    APPS_NONE_UPGRADABLE_TEXT : '您还没有可升级的应用',
