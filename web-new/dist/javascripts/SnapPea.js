...
(function(e){require(["underscore","jquery","doT","ui/TemplateFactory","utilities/QueryString","utilities/BrowserSniffer"],function(t,n,r,i,s,o){if(o.is("wandoujia")&&s.get("debug")!=="true"){var u=e.console,a=function(){};e.console={debug:a,log:a,time:a,timeEnd:a,dir:a,error:a},e.whosYourDaddy=function(){e.console=u}}o.sysIs("WindowsXP")&&n("head").append(r.template(i.get("misc","font-style-xp"))({}))}),require(["jquery","backbone","main/MainRouter","main/views/MainView","main/views/SuggestionInstallWindowView","main/views/BindingDeviceWindowView","doraemon/views/DoraemonModuleView","doraemon/views/GalleryView","message/views/MessageModuleView","browser/views/BrowserModuleView","app/views/AppModuleView","welcome/views/WelcomeModuleView","music/views/MusicModuleView","contact/views/ContactModuleView","photo/views/PhotoModuleView","video/views/VideoModuleView","optimize/views/OptimizeModuleView","app/wash/views/AppWashModuleView","sync/SyncModule","FunctionSwitch","social/SocialService","utilities/Util","Device","Settings","Environment","ui/Notification","ui/TemplateFactory","IOBackendDevice","Configuration","Log","IframeMessageListener","PerformanceTracker"],function(t,n,r,i,s,o,u,a,f,l,c,h,p,d,v,m,g,y,b,w,E,S,x,T,N,C,k,L,A,O,M,_){e.SnapPea=e.SnapPea||{},n.history.start({pushState:!1});var D=i.getInstance();D.regModule("welcome",h),D.render(),D.regModule("doraemon",u),D.regModule("browser",l),D.regModule("message",f),D.regModule("app",c),D.regModule("music",p),D.regModule("photo",v),D.regModule("video",m),D.regModule("contact",d),D.regModule("optimize",g),D.regModule("app-wash",y),D.regModule("gallery",a),e.externalCall("","page_ready",""),_.launch()})})(this);