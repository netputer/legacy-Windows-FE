...
define({
    ...
    NAME : '姓名',
    CELL_PHONE : '移动电话',
    CELL_PHONE_VALIDATE : '您输入的好像不是一个电话号码',
    EMAIL : '电子邮箱',
    EMAIL_VALIDATE : '您输入的好像不是一个电子邮箱',
    ACCOUNT : '账号',
    SAVE : '保存',
    DONTSAVE : '不保存',
    CANCEL : '取消',
    ...
    CONFIRM_EDIT_GROUP : '请确认修改分组！',
    MANAGE_GROUP : '管理分组...',
    CONTACT_RECORD : '联系记录',
    CUSTOME_CONTACT_INFO : '自定义联系信息',
    LABEL : '名称：',
    PLEASE_CONFIRM : '请确认',
    PLEASE_CONFIRM_AGAIN : '亲！您真的确认么亲！！！',
    ...
    BUTTON_DELETE_LABEL : '删除',
    BUTTON_MERGE_LABEL : '合并',
    BUTTON_REFRESH_LABEL : '刷新',
    BUTTON_IMPORT_LABEL : '导入',
    ...
    ALL_ACCOUNT_LABEL : '全部账号',
    ALL_GROUP_LABEL : '全部分组',
    GROUP_MANAGER_LABEL : '管理分组',
    GROUP_UNKNOW_LABEL : '未命名',
    VIEW_LABEL : '显示: ',
    ...
    CONTACT_DELETE_PROGRESS : '正在删除，请稍候...',
    ...
    /* Import and export */
    IMPORT_TITLE_TEXT : '导入联系人',
    DUPLICATE : '已为您忽略了 {1} 条重复联系人。',
    EXPORT_TITLE_TEXT : '导出联系人',
    EXPORT_PROGRESS_DESC1 : '正在导出，请勿断开手机',
    EXPORT_PROGRESS_DESC2 : '正在导出联系人，请稍候...',
    EXPORT_SUCCESS_DESC1 : '导出完成',
    EXPORT_SUCCESS_DESC2 : '联系人导出完成',

    CONTACT_SIM_DELTE_TIP : '您选择了 SIM 卡上的联系人，而您的手机不支持编辑 SIM 卡上的联系人。 <br/><br/>是否自动忽略这些联系人并继续操作 ？',
    ...
    DEL_CONTACT_HEAD : '删除头像',
    ALERT_DEL_CONTACT_HEAD : '确定删除当前联系人头像？',
    ALERT_PIC_FORMAT_ERROR : '很抱歉，目前仅支持 JPG 和 PNG 格式的图片作为头像，请重新选择。',
